...
/atom/movable/screen/sleep/Click()
	...
	if(usr.client?.prefs.read_preference(/datum/preference/toggle/remove_double_click))
		var/tgui_answer = tgui_alert(usr, "Вы уверены, что хотите поспать?", "Сон", list("Да", "Нет"))
