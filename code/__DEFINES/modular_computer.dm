...
#define PDA_THEME_SYNDICATE_NAME "Синдикат"
#define PDA_THEME_CAT_NAME "Кот"
#define PDA_THEME_LIGHT_MODE_NAME "NtOS Светлый Тема"
#define PDA_THEME_SPOOKY_NAME "Мистический"
#define PDA_THEME_HACKERMAN_NAME "Хакерман"
#define PDA_THEME_ROULETTE_NAME "Рулетка"
#define PDA_THEME_ABDUCTOR_NAME "Пришелец"
#define PDA_THEME_BIRD_NAME "Птица"
