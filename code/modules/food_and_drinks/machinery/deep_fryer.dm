...
/obj/machinery/deepfryer/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += span_notice("На дисплее состояния отображается: Скорость жарки - <b>[fry_speed*100]%</b>.<br>Используется <b>[oil_use]</b> [declension_ru(oil_use,"мл","мл","мл")] масла в секунду.")
