/obj/machinery/vending/hydronutrients
	name = "НутриМакс"
	desc = "Торговый автомат с питательными веществами для растений."
	product_slogans = "Разве вы не рады, что вам не нужно удобрять естественным путём?;Теперь на 50% меньше вони!;Растения тоже люди!"
	product_ads = "Мы любим растения!;Не хочешь немного?;Самые зелёные пальцы.;Мы любим большие растения.;Мягкая почва..."
	icon_state = "nutri"
