...
/datum/species/plasmaman/get_physical_attributes()
	return "Плазмамены буквально дышат и живут плазмой. Они самовоспламеняются при контакте с кислородом, и помимо всех связанных с этим особенностей, \
		они очень уязвимы ко всем видам физического урона из-за своей хрупкой структуры."

/datum/species/plasmaman/get_species_description()
	return "Плазмамен - ещё не получили описание, т.к. лор в разработке. :)"
