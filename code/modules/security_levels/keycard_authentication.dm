...
/proc/make_maint_all_access()
	...
	minor_announce("Сняты ограничения на доступ к техническому обслуживанию и внешним воздушным шлюзам.", "Внимание! По всей станции объявлена чрезвычайная ситуация!",1)
