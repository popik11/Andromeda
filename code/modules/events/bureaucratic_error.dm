/datum/round_event_control/bureaucratic_error
	...
	description = "Случайным образом открывает и закрывает слоты профессий, а также изменяет роль переполнения."

/datum/round_event/bureaucratic_error
	announce_when = 1

/datum/round_event/bureaucratic_error/announce(fake)
	priority_announce("Недавняя бюрократическая ошибка может привести к нехватке персонала в некоторых отделах и избыточному в других.", "Бюрократическая ошибка")
