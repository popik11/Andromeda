...
/datum/round_event/supermatter_surge/end()
	...
	priority_announce("Всплеск суперматерии рассеялся, показатели выходной мощности кристалла нормализовались.", "Аномалия устранена")
	engine = null
	sm_gas = null
