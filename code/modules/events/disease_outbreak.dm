...
/datum/round_event/disease_outbreak/announce(fake)
	...
	priority_announce("Подтверждена вспышка вирусной биологической угрозы 7 уровня на борту [station_name()]. Весь персонал должен сдержать распространение.", "Тревога: [illness_type]", ANNOUNCER_OUTBREAK7)
