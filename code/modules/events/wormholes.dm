...
/datum/round_event/wormholes/announce(fake)
	priority_announce("Обнаружены пространственно-временные аномалии на станции. Дополнительные данные отсутствуют.", "Обнаружена аномалия", ANNOUNCER_SPANOMALIES)
