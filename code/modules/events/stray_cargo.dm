...
/datum/round_event/stray_cargo/announce(fake)
	...
	priority_announce("Грузовая капсула обнаружена на сканерах дальнего действия. Ожидаемое место падения: [impact_area.declent_ru(NOMINATIVE)].", "Предупреждение о столкновении")
