...
/datum/round_event/dark_matteor/announce(fake)
	priority_announce("Внимание. Чрезмерное вмешательство в работу метеорных спутников привлекло тёмный мат-еор. Сигнатура приближается к [GLOB.station_name]. Приготовьтесь к столкновению.", "Метеорная тревога", 'sound/announcer/alarm/airraid.ogg')
