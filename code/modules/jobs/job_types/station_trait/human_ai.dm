...
/datum/job/human_ai/announce_job(mob/living/joining_mob)
	...
	if(SSticker.HasRoundStarted())
		minor_announce("Вследствие исследовательского инцидента, [joining_mob] был направлен к вам в качестве замены ИИ в [AREACOORD(joining_mob)]. Пожалуйста, относитесь к ним с уважением.")
