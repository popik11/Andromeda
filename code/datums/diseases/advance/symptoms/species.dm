...
/datum/symptom/undead_adaptation
	...
	desc = "Вирус способен развиваться и функционировать даже в мёртвых носителях."
	stealth = 2
	resistance = -2
	stage_speed = 1
	transmittable = 0
...
/datum/symptom/inorganic_adaptation
	...
	desc = "Вирус способен выживать и размножаться даже в неорганической среде, повышая свою устойчивость и скорость заражения."
	stealth = -1
	resistance = 4
	stage_speed = -2
	transmittable = 3
