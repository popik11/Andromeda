...
/obj/item/proc/openTip(location, control, params, user)
	...
	if(!(item_flags & FORCE_STRING_OVERRIDE))
		openToolTip(user,src,params,title = declent_ru(NOMINATIVE),content = "[desc]<br>[force ? "<b>Сила:</b> [force_string]" : ""]",theme = "")
	else
		openToolTip(user,src,params,title = declent_ru(NOMINATIVE),content = "[desc]<br><b>Сила:</b> [force_string]",theme = "")
