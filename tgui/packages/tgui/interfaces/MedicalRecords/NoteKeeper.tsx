...
export const NoteKeeper = (props) => {
  ...
  return (
    <Section buttons={<NoteTabs />} fill scrollable title="Заметки">
      {writing && (
        <TextArea
          fluid
          height="100%"
...
const NoteTabs = (props) => {
  ...
  return (
    <Tabs>
      ...
      <Tooltip
        content={`Добавьте новую заметку. Нажмите Enter или Escape, чтобы сохранить или выйти из режима просмотра.`}
        position="bottom"
      >
