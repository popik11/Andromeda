...
export const sound_ghost_poll_prompt: FeatureChoiced = {
  name: 'Оповещение опроса призраков',
  category: 'Звук',
  description: 'Выберите, какой звук воспроизводить при получении опросов призраков.',
  component: FeatureDropdownInput,
};

export const sound_ghost_poll_prompt_volume: Feature<number> = {
  name: 'Громкость оповещения опросов призраков',
  category: 'Звук',
  description: 'Громкость, с которой будут воспроизводиться оповещения опросов призраков.',
  component: FeatureSliderInput,
};
